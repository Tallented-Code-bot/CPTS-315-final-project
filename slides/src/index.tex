...
\begin{frame}{Data Collection}
    \begin{itemize}
        \item As the user plays, results of played games are collected
        and stored after a certain given number of games.
        \item Each set of games is stored as a series.
    \end{itemize}
\end{frame}
